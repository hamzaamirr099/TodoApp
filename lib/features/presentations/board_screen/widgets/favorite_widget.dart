          ...
          return Padding(
            ...
            child: Column(
              children: [
                ...
                //     if (AppCubit.get(context).dailyRepeatedTasks[index]
                //             ['favorite'] ==
                //         1) {
                //       return Padding(
                //         padding: const EdgeInsets.only(bottom: 15.0),
                //         child: TaskItem(
                //             taskData: AppCubit.get(context)
                //                 .dailyRepeatedTasks[index]),
                //       );
                //     }
                //     return Container();
                //   },
                ...
                //     itemBuilder: (context, index) {
                //       if (AppCubit.get(context).favoriteTasks[index]
                //               ['repeat'] !=
                //           "Daily") {
                //         return Padding(
                //           padding: const EdgeInsets.only(bottom: 15.0),
                //           child: TaskItem(
                //               taskData:
                //                   AppCubit.get(context).favoriteTasks[index]),
                //         );
                //       }
                //       return Container();
                //     },
                ...
                Expanded(
                  child: ListView(
                    children: AppCubit.get(context)
                      ...
                      ..addAll(
                        AppCubit.get(context).favoriteTasks.map(
                          (taskItem) {
